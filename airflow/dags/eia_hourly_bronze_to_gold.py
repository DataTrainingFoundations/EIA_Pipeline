...
with DAG(
    dag_id="eia_hourly_bronze_to_gold",
    description="Automatically ingest RAW and publish hourly Snowflake SILVER and GOLD partitions.",
    schedule_interval="15 * * * *",
    start_date=days_ago(1),
    catchup=False,
    default_args=default_args,
    tags=["eia", "hourly", "bronze-to-gold", "snowflake"],
    max_active_runs=1,
