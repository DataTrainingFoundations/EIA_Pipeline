...
GLOBAL_BACKFILL_POOL = os.getenv("AIRFLOW_GLOBAL_BACKFILL_POOL", "global_backfill_worker")
GRID_OPERATIONS_SCHEDULE = os.getenv(
    "AIRFLOW_PLATINUM_GRID_OPERATIONS_SCHEDULE",
    os.getenv("AIRFLOW_GRID_OPERATIONS_SCHEDULE", os.getenv("AIRFLOW_GRID_OPS_SCHEDULE", "20 * * * *")),
)
...
BRONZE_VERIFICATION_SCHEDULE = os.getenv("AIRFLOW_BRONZE_VERIFICATION_SCHEDULE", "40 * * * *")
