...
def test_enqueue_backfill_jobs_inserts_newest_windows_first(monkeypatch) -> None:  # noqa: ANN001
    ...
    assert inserted == 2
    assert cursor.inserted_params[0][1].isoformat() == "2026-03-10T00:00:00+00:00"
    assert cursor.inserted_params[0][2].isoformat() == "2026-03-11T00:00:00+00:00"
    assert cursor.inserted_params[1][1].isoformat() == "2026-03-09T00:00:00+00:00"
